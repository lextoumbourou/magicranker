...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerShare.total_debt_ratio'
        db.add_column(u'stock_pershare', 'total_debt_ratio',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PerShare.total_debt_ratio'
        db.delete_column(u'stock_pershare', 'total_debt_ratio')
