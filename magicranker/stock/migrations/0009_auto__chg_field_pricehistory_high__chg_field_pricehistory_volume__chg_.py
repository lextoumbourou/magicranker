...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PriceHistory.high'
        db.alter_column(u'stock_pricehistory', 'high', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PriceHistory.volume'
        db.alter_column(u'stock_pricehistory', 'volume', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'PriceHistory.low'
        db.alter_column(u'stock_pricehistory', 'low', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PriceHistory.close'
        db.alter_column(u'stock_pricehistory', 'close', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PriceHistory.open'
        db.alter_column(u'stock_pricehistory', 'open', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

        # Changing field 'PriceHistory.adjusted_close'
        db.alter_column(u'stock_pricehistory', 'adjusted_close', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PriceHistory.high'
        db.alter_column(u'stock_pricehistory', 'high', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))

        # Changing field 'PriceHistory.volume'
        db.alter_column(u'stock_pricehistory', 'volume', self.gf('django.db.models.fields.BigIntegerField')(default=None))

        # Changing field 'PriceHistory.low'
        db.alter_column(u'stock_pricehistory', 'low', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))

        # Changing field 'PriceHistory.close'
        db.alter_column(u'stock_pricehistory', 'close', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))

        # Changing field 'PriceHistory.open'
        db.alter_column(u'stock_pricehistory', 'open', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))

        # Changing field 'PriceHistory.adjusted_close'
        db.alter_column(u'stock_pricehistory', 'adjusted_close', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=10, decimal_places=2))
