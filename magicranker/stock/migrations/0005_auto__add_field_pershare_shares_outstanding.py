...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PerShare.shares_outstanding'
        db.add_column('stock_pershare', 'shares_outstanding',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PerShare.shares_outstanding'
        db.delete_column('stock_pershare', 'shares_outstanding')
