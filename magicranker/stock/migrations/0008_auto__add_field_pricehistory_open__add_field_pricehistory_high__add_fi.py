...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PriceHistory.open'
        db.add_column(u'stock_pricehistory', 'open',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'PriceHistory.high'
        db.add_column(u'stock_pricehistory', 'high',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'PriceHistory.low'
        db.add_column(u'stock_pricehistory', 'low',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'PriceHistory.adjusted_close'
        db.add_column(u'stock_pricehistory', 'adjusted_close',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


        # Changing field 'PriceHistory.close'
        db.alter_column(u'stock_pricehistory', 'close', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'PriceHistory.open'
        db.delete_column(u'stock_pricehistory', 'open')

        # Deleting field 'PriceHistory.high'
        db.delete_column(u'stock_pricehistory', 'high')

        # Deleting field 'PriceHistory.low'
        db.delete_column(u'stock_pricehistory', 'low')

        # Deleting field 'PriceHistory.adjusted_close'
        db.delete_column(u'stock_pricehistory', 'adjusted_close')


        # Changing field 'PriceHistory.close'
        db.alter_column(u'stock_pricehistory', 'close', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        u'stock.pricehistory': {
            ...
            'adjusted_close': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'close': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'code': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['stock.Detail']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'high': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'low': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'open': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
